public class Druid extends PlayerCharacter {
    ...
    public Druid(String newName) {

        System.out.println("A new Druid has been created!");
        ...
        agility = 5 + Die.roll();;
        wisdom = 15 + Die.roll();;
        constitution = 15 + Die.roll();;

        hp = maxhp = strength + (2 * constitution);
        mp = maxmp = (2*intelligence) + (2 * wisdom);

    }

    public void showStats() {
        System.out.printf("%s, a Druid:\n",name);
        super.showStats();
