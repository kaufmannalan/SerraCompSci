...
public class Main {
    ...
    public static String [] indvotes = votes.split(";");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mordy Golding received " + x1 + " votes.");
        System.out.println("Shira Gotshalk received " + x2 + " votes.");
        System.out.println("Stephanie Evans received " + x3 + " votes.");
        System.out.println("Ray Villalobos received " + x4 + " votes.");
        ...
        System.out.println("Dona Sarkar received " + y1 + " votes.");
        System.out.println("Tyler Ahn received " + y2 + " votes.");
        System.out.println("Joe Camp received " + y3 + " votes.");
        System.out.println("Brandon LeBlanc received " + y4 + " votes.");
        ...
        System.out.println("Jason Howard received " + z1 + " votes.");
        System.out.println("Nikki Rubino received " + z2 + " votes.");
        System.out.println("Peggy Fisher received " + z3 + " votes.");
        System.out.println("Neil Edde received " + z4 + " votes.");
